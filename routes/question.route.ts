...
import { checkanswer, createQuestion, deleteQuestion, editQuestion, getAllQuestions, getQuestion, getQuestionbycategory } from "../controllers/question.controller"
...
questionRouter.get('/:category',usermiddleware,getQuestionbycategory)
questionRouter.post('/checkanswer/:id',usermiddleware,checkanswer)
questionRouter.post("/filter",usermiddleware,getAllQuestions)